...
var orderDash = new dashboard_1.orderDashboard();
...
var post_order_product = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var order_product, new_order_product, err_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
...
var get_active_orders = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user_id, orders, err_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                user_id = parseInt(req.params.id);
                return [4 /*yield*/, orderDash.index(user_id)];
            case 1:
                orders = _a.sent();
                res.json(orders);
                return [3 /*break*/, 3];
