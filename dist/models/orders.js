        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("could not get order, ".concat(err_2, " "));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("could not create order, ".concat(err_3, " "));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = "UPDATE orders SET order_status= $1, user_id = $2 WHERE id = $3 RETURNING *";
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("could not update orderr, ".concat(err_4, " "));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_5 = _a.sent();
                        throw new Error("could not delete order, ".concat(err_5, " "));
                    case 4: return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, conn.query(sql, [order_product.order_id, order_product.product_id, order_product.quantity])];
                    case 2:
                        results = _a.sent();
                        conn.release();
                        return [2 /*return*/, results.rows[0]];
                    case 3:
                        err_6 = _a.sent();
                        throw new Error("could not create add product, ".concat(err_6, " "));
                    case 4: return [2 /*return*/];
                }
            });
        });
