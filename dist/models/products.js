        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = "INSERT INTO products (p_name, price, category) VALUES ($1, $2, $3) RETURNING *";
                        return [4 /*yield*/, conn.query(sql, [product.p_name, product.price, product.category])];
                    case 2:
                        results = _a.sent();
                        conn.release();
                        return [2 /*return*/, results.rows[0]];
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("could not create product, ".concat(err_3, " "));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = "UPDATE products SET p_name = $1, price = $2, category = $3 WHERE id = $4 RETURNING *";
                        return [4 /*yield*/, conn.query(sql, [product.p_name, product.price, product.category, product.id])];
                    case 2:
                        results = _a.sent();
                        conn.release();
                        return [2 /*return*/, results.rows[0]];
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("could not update products, ".concat(err_4, " "));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_5 = _a.sent();
                        throw new Error("could not delete product, ".concat(err_5, " "));
                    case 4: return [2 /*return*/];
                }
            });
        });
